...
import { CATEGORY_PROFILES, getCategoryProfile } from '../category-profiles';

import {
  ConsultationCore,
  type ConsultationNeedSnapshot,
} from '../consultation-core/consultation-core';
...
import type { ComparisonPresentation } from '../schemas/comparison-presentation.schema';

import type { ProductDetailsPresentation } from '../schemas/product-presentation.schema';
